...
//PRE: - .
//POST: Devuelve true si el valor en el par es no nulo, o false en caso contrario.
...
void inserciones_hash_todo_valido()
{
	...
	hash_prueba = hash_insertar(hash_prueba, clave_prueba_1,
				    elemento_prueba_1, &anterior);
	hash_prueba = hash_insertar(hash_prueba, clave_prueba_2,
